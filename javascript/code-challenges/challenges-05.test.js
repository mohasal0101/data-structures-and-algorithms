...
const reversedString = (str) => {
  // Solution code here...
  let reversedString = str.split('').reduce((acc, value)=>{
    acc = value + acc;
    return acc;
  }
  ,'');
...
const countNumberOfChildren = (arr) => {
  // Solution code here...
  let numberOfChildren = arr.reduce((acc, value)=>{
...
const calculateAverage = (arr) => {
  ...
  ,{count:0, sum:0}).sum / (arr.reduce((acc, value)=>{
    acc.sum = acc.sum + value;
    acc.count = acc.count + 1;
    return acc;
  }
...
const countPrimeNumbers = (arr) => {
  // Solution code here...
  let primeNumbers = arr.reduce((acc, value)=>{
    if(isPrime(value)){
      acc = acc + 1;
    }
    return acc;
